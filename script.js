...
(function () {
    ...
    (function notes() {
        ...
        var NOTES = [
            "You possess one of those smiles around which the entire world quietly reorders its architecture.",
            "Somewhere yonder, a convalescent's finest morning shall commence with your name embroidered upon the coat.",
            "Were reverie an athletic discipline, your supremacy in it would border on the inequitable.",
            "You are ninety parts benevolence, ten parts pandemonium, and wholly worth the acquaintance.",
            "On the days you deem yourself unremarkable, be apprised that the cosmos demurs emphatically.",
            "Gelato dissolves and confectionery is depleted, yet your particular sweetness is of the enduring sort.",
            "In due course, 'Dr. Sadia Islam Arpi' shall ring entirely unremarkable. Permit that to permeate.",
            "You do not pursue the luminescence; more frequently, you are the very pretext for its arrival.",
            "Whatever you presently overcontemplate is more diminutive than its clamour pretends. Verily.",
            "The world bequeathed you a capacious heart and impeccable discernment. Fortunate world.",
            "Venture where the airfare is negligible and the remembrances are extravagantly dear.",
            "You are sanctioned to be both a magnum opus and an unfinished endeavour concurrently.",
            "Physician-in-waiting, perennial daydreamer, and a certified affliction upon every sour disposition.",
            "Were compassion rendered as couture, you would grace the frontispiece of every season.",
            "Some illuminate a chamber; you illuminate the chamber, the thoroughfare, and the entire correspondence.",
            "Be as tender as your dessert requisition and as audacious as your itineraries.",
            "The constellations are merely the firmament's diffident attempt at what you accomplish without exertion.",
            "A reminder: you are administering this affair with greater competence than your apprehensions concede.",
            "May your coffee be potent, your peripeteias plentiful, and your misgivings exceedingly reticent.",
            "You stand as living corroboration that the gentle and the indomitable may share a single pulse.",
            "Snowdrop was an estimable drama; your own narrative, however, persists in eclipsing it.",
            "Retain that obstinate, munificent heart, for it is destined to mend a great many others.",
            "You, my friend, are a limited edition. Kindly never lapse into the generic.",
            "Wherever you elect to alight hereafter, that locale has just grown inordinately fortunate."
        ];
        var ICONS = ['🎀', '🌸', '💌', '✨', '🤍', '🌷', '💫', '🩷'];
